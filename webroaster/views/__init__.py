...
from webroaster.forms_finance import (
    AdvanceForm,
    BudgetForm,
    ExpenseForm,
...
from webroaster.forms_hr import (
...
from webroaster.forms_operations import (
    AssetAssignmentForm,
    AssetForm,
    AttendanceForm,
    ClientForm,
...
from webroaster.forms_public import AssociatedLinkForm, CompanyEventForm, JobApplicationForm, JobPostingForm, WebsiteAdvertisementForm, WebsiteResourceForm
from webroaster.access import (
    can_access_model,
...
MODEL_CONFIGS = {
    ...
    "contracts": {"model": Contract, "form": ContractForm, "title": "Contracts", "icon": "CT", "fields": ["contract_id", "contract_number", "client", "client_name", "day_shift_guards", "night_shift_guards", "number_of_guards", "remaining_guards", "rate_per_guard", "contract_value"], "detail_fields": ["contract_id", "contract_number", "client", "client_name", "contact_person", "phone_number", "email", "address", "contract_start_date", "contract_end_date", "number_of_sites", "day_shift_guards", "night_shift_guards", "number_of_guards", "site_required_guards", "remaining_guards", "rate_per_guard", "guard_contract_value", "deliverables_value", "contract_value", "contract_status"]},
    "regions": {"model": Region, "form": RegionForm, "title": "Regions", "icon": "RG", "fields": ["region_id", "region_name", "description"], "required_only": False},
    "sites": {"model": Site, "form": SiteForm, "title": "Sites", "icon": "ST", "fields": ["site_id", "site_code", "region", "client", "contract", "site_name", "site_address", "day_shift_guards", "night_shift_guards", "number_of_guards"], "detail_fields": ["site_id", "site_code", "region", "client", "contract", "site_name", "site_address", "day_shift_guards", "night_shift_guards", "number_of_guards"], "required_only": False},
    ...
    "asset-assignments": {"model": AssetAssignment, "form": AssetAssignmentForm, "title": "Asset Assignments", "icon": "AA", "fields": ["asset", "quantity", "assigned_to", "issued_by", "received_by", "assigned_date", "status", "accountability_status"], "detail_fields": ["assignment_id", "asset", "quantity", "assigned_to", "guard", "driver", "site", "deployment", "issued_by", "received_by", "assigned_date", "acknowledged_at", "return_date", "status", "accountability_status", "condition_issued", "condition_returned", "notes", "accountability_notes", "created_at", "updated_at"], "entry_fields": ["asset", "quantity", "guard", "driver", "site", "deployment", "issued_by", "received_by", "assigned_date", "return_date", "status", "condition_issued", "condition_returned", "notes", "accountability_notes"], "required_only": False},
    "incidents": {
        "model": Incident,
        "form": IncidentForm,
        "title": "Incidents",
    ...
    "deployments": {"model": Deployment, "form": DeploymentForm, "title": "Deployments", "icon": "DP", "fields": ["client", "site", "shift_summary", "day_guards_summary", "night_guards_summary", "start_date", "end_date", "status"], "entry_fields": ["client", "site", "shift_type", "day_guards", "night_guards", "start_date", "end_date", "status"], "required_only": False},
    ...
    "salaries": {"model": Salary, "form": SalaryForm, "title": "Salaries", "icon": "SA", "fields": ["employee", "shifts_worked", "overtime_shifts", "daily_rate", "basic_salary", "overtime_pay", "allowances", "loan_deduction", "medical_deduction", "advance_recovery", "ledger_installment_amount", "ledger_advance_balance", "total_deductions", "total_salary", "pay_period"], "detail_fields": ["employee", "pay_period", "period_start_date", "period_end_date", "shifts_worked", "overtime_shifts", "daily_rate", "overtime_daily_rate", "basic_salary", "overtime_pay", "allowances", "loan_deduction", "medical_deduction", "other_payroll_deductions", "advance_recovery", "ledger_installment_amount", "ledger_advance_balance", "deductions", "bonus", "gross_pay", "total_deductions", "total_salary"], "required_only": False, "managed_table": True},
    "advances": {"model": Advance, "form": AdvanceForm, "title": "Advances", "icon": "AD", "fields": ["advance_id", "employee", "amount_requested", "installment_amount", "balance", "verification_status", "approval_status", "status", "disbursement_date"], "detail_fields": ["advance_id", "employee", "amount_requested", "installment_amount", "balance", "verification_status", "verified_by", "verified_at", "approval_status", "approved_by", "disbursement_date", "status", "created_at", "updated_at"], "entry_fields": ["employee", "amount_requested"], "required_only": False},
...
def get_field_label(model, field_name):
    ...
    custom_labels = {
        ...
        "day_guards_summary": "Day Shift Guards",
        "night_guards_summary": "Night Shift Guards",
        ...
        "site_required_guards": "Site Guards",
        "assigned_guards_count": "Assigned Guards",
        "remaining_guards": "Remaining Guards",
        "site_code": "Site Code",
    }
