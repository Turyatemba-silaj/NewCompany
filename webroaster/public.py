...
def public_home(request):
    ...
    return public_render(request, "webroaster/public_home.html", context)
...
def public_page(request, page):
    ...
    return public_render(request, "webroaster/public_page.html", page_data[page])
...
def careers(request):
    ...
    return public_render(request, "webroaster/careers.html", context)
...
def job_detail(request, pk):
    ...
    if not job.is_open:
        ...
        return redirect("webroaster:careers")
    ...
    if request.method == "POST" and form.is_valid():
        ...
        return redirect("webroaster:job_detail", pk=job.pk)
    context = {
        "title": job.title,
        "active_public": "careers",
        "job": job,
    ...
    return public_render(request, "webroaster/job_detail.html", context)
